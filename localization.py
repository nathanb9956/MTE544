...
class localization(Node):
    ...
    def odom_callback(self, pose_msg):
        ...
        odom_theta = pose_msg.pose.pose.orientation
        odom_x = pose_msg.pose.pose.position.x
        odom_y = pose_msg.pose.pose.position.y
        timestamp = pose_msg.header.stamp

        self.pose=[odom_x, odom_y, odom_theta,timestamp]
